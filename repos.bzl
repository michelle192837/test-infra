...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:tikhlQEJeezbnu0Zcblj7g5vm/L7xt6g1vnfq8mRCS4=",
        version = "v0.0.0-20191002211648-c459b9ce5143",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/li+i5emVvcFlHC1e71ZJJSVrzvLQoTCC9AERUBeoAA=",
        version = "v0.0.0-20191002194340-462e7a9505a0",
    )
    go_repository(
